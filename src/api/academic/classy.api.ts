...
import { AcademicPeriod, AcademicShift, Classy, ClassyRoom, Contact, Course, EnrollmentConfirmation } from "../../models/index";
...
class ClassyApi {
  ...
  find = async (req: Request, res: Response): Promise<Response> => {
    ...
    const include = [AcademicShift, ClassyRoom,Course, AcademicPeriod,EnrollmentConfirmation];
